...
- **步骤**： 1) 重新启动并检查标题栏和应用程序菜单；确认
  ...
  触发另一个工件。 6) 在会话 A 中，让面板保持打开状态，并显示多个
...
- **先决条件**：原生 macOS、Windows 和 Linux 运行程序；内置桌面
  应用程序；提供英语和中文语言环境。 Windows/Linuxharness可设置
...
- **步骤**： 1) 让 Agent 使用固定标题、Markdown 和
  ...
  `plan_approvals` 行。 3）检查卡牌的标题和工件开启者；确认
